...
/**
 * Fluent helper to update an existing {@link com.s4sdkexample.mkt.payloads.namespaces.mktcouponsrv.CouponCodes CouponCodes} entity and save it to the S/4HANA system.<p>
 * To perform execution, call the {@link #execute execute} method on the fluent helper object.
 * 
 */
@RequiredArgsConstructor
public class CouponCodesUpdateFluentHelper
    extends FluentHelperUpdate<CouponCodesUpdateFluentHelper, CouponCodes>
{
